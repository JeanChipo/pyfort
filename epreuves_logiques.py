...
def tictactoe(joueur):
    ...
    def vérif_saisie_est_valide(saisie_j:list, plateau:list, player:int) -> bool:
    ...
    def action(plateau:list,player:int) -> list:
        ...
        if player == 1: # si c'est au tour de l'utilisateur, demande la saisie du joueur, la vérifie et place le pion sur la grille si elle est correcte
            ...
            if vérif_saisie_est_valide(saisie_j, plateau, player) == False: #vérification de la saisie et refait une boucle si la saisie n'est pas correcte
            ...
            if vérif_saisie_est_valide(saisie_j, plateau, player) == False: # vérifie si la saisie du maitre est correcte
                action(plateau, player)
